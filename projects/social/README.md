...
Would result in 100 \* 10 = 1000 friendships. Each friendship has two ways its connected so you devide by two (and if decimal round) 1000 / 2 === 500

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

With every dgree of seperation, the people in a certain persons network increases by (friends)^ (deg of seperation) = num users. in this case its 5^n = 1000. So it would be
n = 4.29203, rounded down to an average of 4 people in that user's extended social network

(in our case we have 10 users and 2 average friends so its 2^n = 10. n = 3.321928)
